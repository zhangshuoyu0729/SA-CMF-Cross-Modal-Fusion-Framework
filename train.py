...
from imgae_feature import extract_image_features
from text_feature import load_text_features_as_tensor
...
def train_model(vocab_size, max_len, embed_dim,
    ...
    image_folder = "D:/feature fusion/data/fusion/"
    text_folder = "D:/feature fusion/data/label/"
    ...
    temp_feat, rad_feat = load_text_features_as_tensor(
        text_folder, len(image_paths), split_idx=16
    )
